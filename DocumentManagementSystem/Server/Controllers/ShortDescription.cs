        ...
        public List<ShortDescriptionDocumentation> Get()
        {
            List<ShortDescriptionDocumentation> documents = new()
            {
                ...
                new ShortDescriptionDocumentation()
                {
                    Id = Guid.NewGuid(),
                    Code = "ECPF",
                    Name = "Электронный клинический фармаколог(полный)",
                ...
                new ShortDescriptionDocumentation()
                {
                    ...
                    Code = "FT",
                    Name = "PharmTAXI",
                    Description = "ФАРМТАКСИ – СИСТЕМА ЭЛЕКТРОННЫХ РЕЦЕПТОВ. Система осуществляет передачу списка лекарственных назначений от врача к пациенту и от пациента в аптеку. " +
